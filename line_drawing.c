...
void draw_line(t_point *a, t_point *b, t_data *img)
{
	...
	if (ft_abs(dx) > ft_abs(dy))
		slope_less_then_one(dx, dy, a, b, img);
	else
		slope_bigger_than_one(dx, dy, a, b, img);
}
...
void slope_less_then_one(int dx, int dy, t_point *a, t_point *b, t_data *img)
{
	int p;
	int i;
...
void slope_bigger_than_one(int dx, int dy, t_point *a, t_point *b, t_data *img)
{
	int p;
	int i;
